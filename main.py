...
def inventory_fill(mu: np.array, variance: np.array) -> np.array:
    ...
    # TODO: check if inventory should be rounded up
        ...
        for store1 in range(11):
            for store2 in range(11):
                for store3 in range(11):
                    ...
                    # TODO: check if demand per store is independent
        ...
        for store1 in range(11):
            for store2 in range(11):
                for store3 in range(11):
                    ...
                    for action1 in range(0, 10-store1):
                        for action2 in range(0, 10-store2):
                            for action3 in range(0, 10-store3):
